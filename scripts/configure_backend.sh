...
# Define the paths to the backend directories for User management
MANAGEMENT_BACKEND_DIR="${SCRIPT_DIR}/../iac/management"
echo "User management backend directory: $MANAGEMENT_BACKEND_DIR"
...
# Define the backend configuration file path for user management
MANAGEMENT_BACKEND_CONFIG="${MANAGEMENT_BACKEND_DIR}/backend.tf"
echo "User management backend config file: $MANAGEMENT_BACKEND_CONFIG"
...
update_backend_config "${MANAGEMENT_BACKEND_CONFIG}"
